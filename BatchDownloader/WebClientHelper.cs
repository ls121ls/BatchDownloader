    ...
    public class WebClientHelper
    {
        ...
        private byte[] GetData(HttpWebRequest request)
        {
            try
            {
                ...
                string s = responseHeaders.GetValues("content-disposition").FirstOrDefault();
                FileName =
                    GetFileName(Encoding.GetEncoding("gbk").GetString(Encoding.GetEncoding("ISO-8859-1").GetBytes(s)));
